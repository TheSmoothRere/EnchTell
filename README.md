...
Ench Tell shows you what an enchantment does the moment you hover over it, adding a description of the enchantment directly to the tooltip.
...
Toggle `showOnItems: true/false` to control whether enchantment descriptions appear on enchanted items.
